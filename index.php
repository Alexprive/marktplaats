...
if ($user->isLoggedIn()) {
    ...
    echo "<p class='label label-success'>Success! U bent ingelogd!</p><br><br>";
    ?>
    <p>
        Hallo <a href="profile.php?user=<?php echo escape($user->data()->username); ?>"><?php echo escape($user->data()->name); ?></a>
    </p>
    ...
    echo "<p>U kunt<a href='login.php'>Inloggen</a> or <a href='register.php'>registreren</a></p>";
}
